...
const ManageBookingsPage = () => {
    ...
    useEffect(() => {
        const fetchBookings = async () => {
            try {
                ...
                const allBookings = response.bookingList || [];  // Fallback to empty array if undefined
    ...
    const currentBookings = filteredBookings.slice?.(indexOfFirstBooking, indexOfLastBooking) || [];  // Fallback to empty array if undefined
